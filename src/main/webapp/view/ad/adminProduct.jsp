  ...
  <table class="table table-bordered">
    ...
    <c:forEach var="p" items="${productList}" varStatus="loop">
      <tr>
        ...
        <td>
          <img src="${pageContext.request.contextPath}/image?file=${fn:substringAfter(p.image, 'image\\')}" alt="${p.name}" width="60" height="60" />
        </td>
        <td>
          <a href="javascript:void(0);" class="btn btn-sm btn-info mb-1" onclick="openEditProductModal(${p.id})">
...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content" id="addProductContent"></div>
  </div>
</div>
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content" id="editProductContent"></div>
  </div>
</div>
